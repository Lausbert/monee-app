...
O Monee desenvolveu a aplicação Monee como uma aplicação Freemium. Este SERVIÇO é fornecido pelo Monee sem custo e destina-se a ser usado como está.

Esta página é usada para informar os visitantes sobre as nossas políticas com a recolha, uso e divulgação de Informações Pessoais se alguém decidir usar o nosso Serviço.

Se escolher usar o nosso Serviço, então concorda com a recolha e uso de informações em relação a esta política. As Informações Pessoais que recolhemos são usadas para fornecer e melhorar o Serviço. Não usaremos ou partilharemos as suas informações com ninguém, exceto como descrito nesta Política de Privacidade.

Responsável em termos de leis de proteção de dados, em particular o Regulamento Geral sobre a Proteção de Dados da UE (RGPD), é:

Stephan Lerner

Se tiver quaisquer perguntas ou sugestões sobre a nossa Política de Privacidade, não hesite em contactar-nos em <{{ site.email_address }}>.

## Os seus direitos

Pode exercer os seguintes direitos a qualquer momento usando os detalhes de contacto fornecidos acima:

- Informações sobre os seus dados armazenados por nós e o seu processamento (Art. 15 RGPD),
- Correção de dados pessoais incorretos (Art. 16 RGPD),
- Eliminação dos seus dados armazenados por nós (Art. 17 RGPD),
- Restrição do processamento de dados se não pudermos eliminar os seus dados devido a obrigações legais (Art. 18 RGPD),
- Objeção ao processamento dos seus dados por nós (Art. 21 RGPD) e
- Portabilidade de dados, desde que tenha consentido ao processamento de dados ou tenha celebrado um contrato connosco (Art. 20 RGPD).
Se nos deu o seu consentimento, pode revogá-lo a qualquer momento.

Pode contactar uma autoridade de supervisão a qualquer momento com uma reclamação, por exemplo, a autoridade de supervisão responsável do estado federal do seu local de residência ou à autoridade responsável por nós como o órgão responsável.

Uma lista das autoridades de supervisão (para a área não pública) com endereço pode ser encontrada [aqui](https://www.bfdi.bund.de/DE/Service/Anschriften/anschriften_table.html).

## Dados de Contacto

Se nos contactar através de correio, os seus dados serão guardados para que possam ser usados para processar e responder à sua solicitação.
...
São processados em particular para o seguinte propósito:
...
- Atribuição de receitas e despesas a uma pessoa no agregado familiar
...
- UUIDs de Instalação Crashlytics
- Traces de falhas
- Dados formatados em minidump Breakpad
...
Valorizamos a sua confiança em fornecer-nos as suas Informações Pessoais, portanto estamos a esforçar-nos por usar meios comercialmente aceitáveis de protegê-las. Mas lembre-se que nenhum método de transmissão pela internet, ou método de armazenamento eletrónico é 100% seguro e confiável, e não podemos garantir a sua segurança absoluta.

## Links para Outros Sites

Este Serviço pode conter links para outros sites. Se clicar num link de terceiros, será direcionado para esse site. Note que estes sites externos não são operados por nós. Portanto, aconselhamos vivamente que reveja a Política de Privacidade destes websites. Não temos controlo sobre e não assumimos responsabilidade pelo conteúdo, políticas de privacidade ou práticas de quaisquer sites ou serviços de terceiros.

## Privacidade das Crianças

Estes Serviços não se dirigem a ninguém com menos de 13 anos. Não recolhemos conscientemente informações pessoais identificáveis de crianças com menos de 13 anos. No caso de descobrirmos que uma criança com menos de 13 anos nos forneceu informações pessoais, eliminamos imediatamente estas dos nossos servidores. Se é pai ou responsável e está ciente de que o seu filho nos forneceu informações pessoais, contacte-nos para que possamos fazer as ações necessárias.

## Alterações a Esta Política de Privacidade

Podemos atualizar a nossa Política de Privacidade de tempos em tempos. Assim, é aconselhado a rever esta página periodicamente para quaisquer alterações. Notificaremos sobre quaisquer alterações publicando a nova Política de Privacidade nesta página.

Esta política é efetiva a partir de 14 de maio de 2022.
