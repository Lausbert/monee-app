...
export default function AppInfo({ appIconUrl, appNameKey, appDescriptionKey, ratings, appStoreData, translations: propTranslations }) {
  ...
  const ratingCount = ratings?.countKey ? t(ratings.countKey) : 'Based on 15.000+ Ratings & Reviews';
  const downloadCount = ratings?.downloadsKey ? t(ratings.downloadsKey) : '350.000+ Downloads worldwide';

  return (
    <div className="appInfo">
      <div className="app-content-wrapper" style={{ display: 'flex', flexWrap: 'nowrap', alignItems: 'flex-start', gap: '20px' }}>
      ...
      <div className="ratings-award-container">
        ...
        <WinnerBadge translations={translations} />
      </div>
